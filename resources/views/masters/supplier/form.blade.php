    ...
    <form action="{{ $supplier->exists ? route('masters.supplier.update', $supplier->ID) : route('masters.supplier.store') }}" method="POST">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" id="ID" name="ID" value="{{ $supplier->exists ? $supplier->ID : 'Auto-Increment' }}" disabled style="background-color: rgba(0,0,0,0.03); color: var(--text-secondary);">
            </div>
