    ...
    <form action="{{ $party->exists ? route('masters.party.update', $party->ID) : route('masters.party.store') }}" method="POST">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" id="ID" name="ID" value="{{ $party->exists ? $party->ID : 'Auto-Increment' }}" disabled style="background-color: rgba(0,0,0,0.03); color: var(--text-secondary);">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="ContactNo" name="ContactNo" value="{{ old('ContactNo', $party->exists ? $party->ContactNo : '+91') }}" placeholder="Enter contact number">
                @error('ContactNo')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="Address" name="Address" value="{{ old('Address', $party->Address) }}" placeholder="Enter address">
                @error('Address')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="Street" name="Street" value="{{ old('Street', $party->Street) }}" placeholder="Enter street">
                @error('Street')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="City" name="City" value="{{ old('City', $party->City) }}" placeholder="Enter city">
                @error('City')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="District" name="District" value="{{ old('District', $party->District) }}" placeholder="Enter district">
                @error('District')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="State" name="State" value="{{ old('State', $party->State) }}" placeholder="Enter state">
                @error('State')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="PinCode" name="PinCode" value="{{ old('PinCode', $party->PinCode) }}" placeholder="Enter pin code">
                @error('PinCode')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
