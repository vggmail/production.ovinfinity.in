    ...
    <form action="{{ $loomnumber->exists ? route('masters.loomnumber.update', $loomnumber->ID) : route('masters.loomnumber.store') }}" method="POST">
        ...
        <div class="form-grid" style="grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));">
            ...
            <div class="form-group">
                ...
                <input type="text" id="ID" name="ID" value="{{ $loomnumber->exists ? $loomnumber->ID : 'Auto-Increment' }}" disabled style="background-color: rgba(255,255,255,0.05); color: rgba(255,255,255,0.4);">
            </div>
